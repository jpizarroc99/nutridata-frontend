  ...
  return (
    ...
    >
      <Container maxWidth="lg">
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', color: 'white' }}>
                ...
                <Typography variant="body2">
                  Santiago, Chile<br />Región Metropolitana
                </Typography>
              </Box>
            </Box>
        ...
        {/* Features Banner */}
        <Box sx={{ pt: 3, borderTop: '1px solid rgba(255,255,255,0.1)', mb: 4 }}>
          <Grid container spacing={3}>
            {[
              { icon: <Security />, title: 'Seguridad Garantizada', desc: 'Datos protegidos con JWT' },
              { icon: <Analytics />, title: 'API REST Completa', desc: 'Endpoints documentados' },
              { icon: <Favorite />, title: 'Para Profesionales', desc: 'Diseñado para nutricionistas' }
            ].map((feature, index) => (

...
export default function Checkout(props) {
  ...
  return (
    <AppTheme {...props}>
      ...
      <Grid container sx={{ height: { xs: "100%", sm: "calc(100dvh - var(--template-frame-height, 0px))" }, mt: { xs: 4, sm: 0 } }}>
        <Grid
          item
          xs={0}
          md={5}
            ...
            {activeStep === steps.length ? (
              <Stack spacing={2} useFlexGap>
                ...
                <Typography variant="body1" sx={{ color: "text.secondary" }}>
                  Your order number is <strong>#140396</strong>. We have emailed your order confirmation.
                </Typography>
              ...
              <>
                ...
                <Box sx={{ display: "flex", flexDirection: { xs: "column-reverse", sm: "row" }, alignItems: "end", flexGrow: 1, gap: 1, pb: { xs: 12, sm: 0 }, mt: { xs: 2, sm: 0 }, mb: "60px", justifyContent: activeStep !== 0 ? "space-between" : "flex-end" }}>
                  {activeStep !== 0 && (
                    <Button startIcon={<ChevronLeftRoundedIcon />} onClick={handleBack} variant="text" sx={{ display: { xs: "none", sm: "flex" } }}>
                      Previous
                    </Button>
                  )}
                  {activeStep !== 0 && (
